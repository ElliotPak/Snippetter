...
macroMap = fromList [("title-page", pageTitle), ("title-entry", entryTitle)]
...
pageStandard params = do
  ...
  return
    [ add $ snippet "build-snippets/header.html"
...
entryTitle params = do
  ...
  return
    [ add $ snippet "resources/snippets/entryTitle.html"
    , replaceText "%TITLE%" title
    , replaceText "%DESC%" desc
...
pageTitle params = do
  ...
  return
    [ add $ snippet "resources/snippets/pageTitle.html"
    , replaceText "%TITLE%" title
    , replaceText "%DESC%" desc
